# -*- coding: utf-8 -*-
"""project_SMT_Z3.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/153a7tspy3mBOCTB-vHmkp-qgvMF9nLIq
"""
...
# max_width
max_w = Int('max_w')
upper_bound_w = max_w == max_z3([X[i] + plates[i][0] for i in range(n)]) <= w # upper bound to width
